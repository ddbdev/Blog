...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/post").hasAuthority("blog:read")
                .antMatchers("/post/new").hasAuthority("blog:write")
                .antMatchers(DELETE, "/post/**").hasRole("ADMIN")
                .antMatchers(PUT, "/post/{id}/**").hasAnyRole("ADMIN", "MODERATOR")
                .antMatchers(PUT, "/post/{id}/**").hasAnyAuthority("blog:write", "blog:comment")
